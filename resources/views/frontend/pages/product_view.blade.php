            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="product-details">
                        ...
                        <div>
                            <h3 class="product-price">{{ $product->price - $product->discount }} <del
                        ...
                        <div class="product-options">
                            <label>
                                ...
                                <select name="" class="input-select">
                                    ...
                                    @php
                                        $sizes = explode(',', $sizes->find($product->size_id)->size);
                                    @endphp
                            ...
                            <label>
                                ...
                                <select class="input-select">
                                    <option value="">select to color</option>
                                    @php
                                        $colors = implode(',', json_decode($colors->find($product->color_id)->color));
                                        $c = explode(',', $colors);
                                    @endphp
                                    @foreach ($c as $item)
                                        <option value="$item">{{ $item }}</option>
                        ...
                        <ul class="product-links">
                            <li>Category:</li>
                            <li><a href="#">{{ $categories->find($product->cat_id)->name }}</a></li>
                            <li><a href="#">{{ $subcategories->find($product->subcat_id)->name }}</a></li>
                        </ul>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="product">
                            ...
                            <div class="product-body">
                                <p class="product-category">{{ $categories->find($item->cat_id)->name }}</p>
                                <h3 class="product-name"><a href="#">{{ $item->name }} goes here</a></h3>
                                <h4 class="product-price">&#2547;{{ $item->price - $item->discount }} <del
                                        class="product-old-price">&#2547;{{ $item->price }}</del></h4>
                                <div class="product-rating">
                                </div>
