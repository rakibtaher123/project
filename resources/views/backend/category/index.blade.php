                    ...
                    <tbody>
                        @foreach ($category as $item)
                            <tr>
                                ...
                                <td class="center">
                                    @if ($item->status == 1)
                                        <a class="btn btn-success" href="{{ url('/categories/' . $item->id) }}">
                                            <i class="halflings-icon white thumbs-down"></i>
                                        </a>
                                    @else
                                        <a class="btn btn-danger" href="{{ url('/categories/' . $item->id) }}">
                                    ...
                                    <form class='d-flex' action="{{ route('categories.destroy',$item->id)}}" method="post">
                                        @csrf
                                        @method("DELETE")
